    ...
    <Layout>
      <section className="py-16 md:py-24 px-4">
        <div className="container mx-auto max-w-5xl">
          <h1 className="section-title mb-8 uppercase text-secondary">Editais</h1>
          {isLoading ? (
            ...
            <p className="text-center text-muted-foreground font-body py-16">Nenhum edital publicado ainda.</p>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {items.map((item) => (
