...
const materials = [
  { image: materialArvores, title: "Árvores Raras na Paisagem", type: "illustration" },
  { image: materialPlano, title: "Plano de Manejo Guararema/SP", subtitle: "Refúgio de Vida Silvestre do Bicudinho", type: "download" },
];
