          ...
          <div className="grid grid-cols-2 gap-6 auto-rows-fr">
            {areas.map((area, i) => {
              return (
                <div
                  key={i}
                  className={`rounded-[2.5rem] p-8 flex flex-col items-center justify-center gap-6 cursor-pointer hover:scale-[1.05] transition-all min-h-[220px] shadow-xl border-4 border-white/10 ${i === 2 ? "col-span-2" : ""}`}
